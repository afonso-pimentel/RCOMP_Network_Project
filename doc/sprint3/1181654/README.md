# RCOMP 2021-2022 Project - Sprint 3 - Building 5 - 1181654
===========================================
...
A script was created and run in the building 5's router (IC) that, applies DHCP to all networks of building 5 except for DMZ network.
